/** load translations **/
function LoadGWTranslation(that) {
  return new Promise(resolve => {
    ...
    Tr.Setting_Credentials_tooltip = that.translate("GW_Setting_Credentials_tooltip")
    ...
    Tr.Setting_Server = that.translate("GW_Setting_Server")
    Tr.Setting_Server_debug = that.translate("GW_Setting_Server_debug")
    Tr.Setting_Server_usePM2 = that.translate("GW_Setting_Server_usePM2")
    Tr.Setting_Server_port = that.translate("GW_Setting_Server_port")
    Tr.Setting_Server_PM2Id = that.translate("GW_Setting_Server_PM2Id")
    Tr.Setting_Server_useMapping = that.translate("GW_Setting_Server_useMapping")
    Tr.Setting_Server_portMapping = that.translate("GW_Setting_Server_portMapping")
...
/** load descriptions **/
function LoadGWDescription(that) {
  return new Promise(resolve => {
    var desc = {}
...
function LoadGWTrSchemaValidation(that) {
  return new Promise(resolve => {
    var Tr = {}
