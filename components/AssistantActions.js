...
function ActionsOnStatusOfGA(that, status) {
  ...
  switch(status) {
    ...
    case "ASSISTANT_THINK":
      ...
      if (that.GW["EXT-Pages"].hello && !hasPluginConnected(that.GW, "connected", true)) that.sendNotification("EXT_PAGES-PAUSE")
    ...
    case "ASSISTANT_STANDBY":
      ...
      if (that.GW["EXT-Pages"].hello && !hasPluginConnected(that.GW, "connected", true)) that.sendNotification("EXT_PAGES-RESUME")
