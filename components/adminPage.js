class adminPageGW {
              ...
              Sysinfo_cpu.appendChild(Sysinfo_cpu_group)
                ...
                Sysinfo_cpu_group.appendChild(Sysinfo_cpu_list)
			        ...
			        Sysinfo_cpu_list.appendChild(Usage)
			          ...
			          Usage_Value.id = "GATEWAY_ADMIN-SYSINFO_CPU-USAGE-VALUE"
			        ...
			        Sysinfo_cpu_list.appendChild(Temp)
			          ...
			          Temp_Value.id = "GATEWAY_ADMIN-SYSINFO_CPU-TEMP-VALUE"
              ...
              Sysinfo_memory.appendChild(Sysinfo_memory_group)
                ...
                Sysinfo_memory_group.appendChild(Sysinfo_memory_list)
			        ...
			        Sysinfo_memory_list.appendChild(Active)
			          ...
			          Active_Value.id = "GATEWAY_ADMIN-SYSINFO_MEMORY-ACTIVE-VALUE"
			        ...
			        Sysinfo_memory_list.appendChild(Swap)
			          ...
			          Swap_Value.id = "GATEWAY_ADMIN-SYSINFO_MEMORY-SWAP-VALUE"
  ...
  refreshData() {
    ...
    Speed_Value.textContent= this.System.CPU.speed
    var Usage_Value = document.getElementById("GATEWAY_ADMIN-SYSINFO_CPU-USAGE-VALUE")
    Usage_Value.textContent= this.System.CPU.usage + "%"
    var Governor_Value = document.getElementById("GATEWAY_ADMIN-SYSINFO_CPU-GOVERNOR-VALUE")
    Governor_Value.textContent= this.System.CPU.governor
    var Temp_Value = document.getElementById("GATEWAY_ADMIN-SYSINFO_CPU-TEMP-VALUE")
    Temp_Value.textContent = this.System.CPU.temp.C + "°"

    /* MEMORY */
    var Active_Value = document.getElementById("GATEWAY_ADMIN-SYSINFO_MEMORY-ACTIVE-VALUE")
    Active_Value.textContent = this.System.MEMORY.used + " / " + this.System.MEMORY.total + " ("+ this.System.MEMORY.percent + "%)"
    var Swap_Value = document.getElementById("GATEWAY_ADMIN-SYSINFO_MEMORY-SWAP-VALUE")
    Swap_Value.textContent= this.System.MEMORY.swapUsed + " / " + this.System.MEMORY.swapTotal + " ("+ this.System.MEMORY.swapPercent + "%)"
  }
