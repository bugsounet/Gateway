...
Module.register("Gateway", {
  ...
  LoadGWTranslation: function() {
    return new Promise(resolve => {
      ...
      Tr.Plugins_Delete_Confirm = this.translate("GW_Plugins_Delete_Confirm")
      Tr.Plugins_Delete_Error = this.translate("GW_Plugins_Delete_Error")
      Tr.Plugins_Delete_Delete = this.translate("GW_Plugins_Delete_Delete")
      Tr.Plugins_Delete_Cancel = this.translate("GW_Plugins_Delete_Cancel")
      ...
      Tr.Plugins_Install_Confirm = this.translate("GW_Plugins_Install_Confirm")
      Tr.Plugins_Install_Error = this.translate("GW_Plugins_Install_Error")
      Tr.Plugins_Install_Install = this.translate("GW_Plugins_Install_Install")
      Tr.Plugins_Install_Cancel = this.translate("GW_Plugins_Install_Cancel")
      Tr.Plugins_Initial_Title = this.translate("GW_Plugins_Initial_Title")
      Tr.Plugins_Initial_Save = this.translate("GW_Plugins_Initial_Save")
      Tr.Plugins_Initial_Wait = this.translate("GW_Plugins_Initial_Wait")
      Tr.Plugins_Initial_Done = this.translate("GW_Plugins_Initial_Done")
      Tr.Plugins_Initial_Error = this.translate("GW_Plugins_Initial_Error")
      Tr.Plugins_Initial_Restart = this.translate("GW_Plugins_Initial_Restart")
      Tr.Plugins_Initial_ErrModule = this.translate("GW_Plugins_Initial_ErrModule")
      Tr.Plugins_DeleteConfig_Title = this.translate("GW_Plugins_DeleteConfig_Title")
      Tr.Plugins_DeleteConfig_Confirm = this.translate("GW_Plugins_DeleteConfig_Confirm")
      Tr.Plugins_DeleteConfig_Wait = this.translate("GW_Plugins_IDeleteConfig_Wait")
      Tr.Plugins_DeleteConfig_Done = this.translate("GW_Plugins_DeleteConfig_Done")
      Tr.Plugins_DeleteConfig_Error = this.translate("GW_Plugins_DeleteConfig_Error")
      Tr.Plugins_DeleteConfig_Restart = this.translate("GW_Plugins_DeleteConfig_Restart")
      ...
      Tr.Plugins_Modify_Save = this.translate("GW_Plugins_Modify_Save")
      Tr.Plugins_Modify_Wait = this.translate("GW_Plugins_Modify_Wait")
      Tr.Plugins_Modify_Done = this.translate("GW_Plugins_Modify_Done")
      Tr.Plugins_Modify_Error = this.translate("GW_Plugins_Modify_Error")
      Tr.Plugins_Modify_Restart = this.translate("GW_Plugins_Modify_Restart")
      Tr.Plugins_Modify_ErrModule = this.translate("GW_Plugins_Modify_ErrModule")
